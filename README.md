...
- Adds the ability to support
- [@vllc/tsc-staged](./packages/tsc-staged) - main package, compiles only staged files
- [@vllc/eslint-tsc-staged](./packages/tsc-staged) - eslint support
- [@vllc/jest-tsc-staged](./packages/tsc-staged) - jest support
